...
const router: Record<string, IRoute> = {
    ...
    annualByClass: { id: "annualByClass", p: "/annual-class", private: true, title: "מערכת שבועית לפי כיתה" },
    annualByTeacher: { id: "annualByTeacher", p: "/annual-teacher", private: true, title: "מערכת שבועית לפי מורה" },
