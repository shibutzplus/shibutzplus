...
const router: Record<string, IRoute> = {
    ...
    annualAltBuild: { id: "annualAltBuild", p: "/annual-alt-build", private: true, title: "מערכת בזמן חירום - בניית מערכת" },
    annualAltView: { id: "annualAltView", p: "/annual-alt-view", private: true, title: "מערכת בזמן חירום" },
