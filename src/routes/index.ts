...
const router: Record<string, IRoute> = {
    ...
    onboarding: { id: "onboarding", p: "/onboarding", private: true, title: "הרשמה" },
    onboardingUserInfo: { id: "onboardingUserInfo", p: "/onboarding/user-info", private: true, title: "הרשמה" },
    onboardingSchoolInfo: { id: "onboardingSchoolInfo", p: "/onboarding/school-info", private: true, title: "הרשמה" },
    classes: { id: "classes", p: "/classes", private: true, title: "רשימת כיתות" },
    teachers: { id: "teachers", p: "/teachers", private: true, title: "רשימת מורים" },
    subjects: { id: "subjects", p: "/subjects", private: true, title: "רשימת מקצועות" },
    substitute: { id: "substitute", p: "/substitute", private: true, title: "מורים מחליפים" },
