...
import styles from "./MngrAnnualViewCell.module.css";
...
const MngrAnnualViewCell: React.FC<MngrAnnualViewCellProps> = ({
    day,
    hour,
    schedule,
    selectedClassId,
...
export default MngrAnnualViewCell;
