...
import styles from "./TeacherDailyChangesInstructionsCell.module.css";
...
type TeacherDailyChangesInstructionsCellProps = {
    row: TeacherScheduleType | undefined;
    teacher?: TeacherType;
    selectedDate: string;
};

const TeacherDailyChangesInstructionsCell: React.FC<TeacherDailyChangesInstructionsCellProps> = ({
    row,
    teacher,
    selectedDate,
}) => {
...
export default TeacherDailyChangesInstructionsCell;
