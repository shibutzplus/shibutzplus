...
import TeacherDailyChangesRow from "../TeacherDailyChangesRow/TeacherDailyChangesRow";
import styles from "./TeacherDailyChangesTable.module.css";
...
type TeacherDailyChangesTableProps = {
    teacher?: TeacherType;
    selectedDate: string;
...
const TeacherDailyChangesTable: React.FC<TeacherDailyChangesTableProps> = ({
    teacher,
    selectedDate,
    isInsidePanel,
    fromHour = 1,
...
export default TeacherDailyChangesTable;
