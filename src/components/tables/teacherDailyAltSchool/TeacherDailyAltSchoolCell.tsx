...
import styles from "./TeacherDailyAltSchoolCell.module.css";
import { SubjectType } from "@/models/types/subjects";
import { TeacherType } from "@/models/types/teachers";
import { WeeklySchedule } from "@/models/types/annualSchedule";
import { ClassType } from "@/models/types/classes";

type TeacherDailyAltSchoolCellProps = {
    day: string;
    hour: number;
...
const TeacherDailyAltSchoolCell: React.FC<TeacherDailyAltSchoolCellProps> = ({
    day,
    hour,
    schedule,
    selectedClassId,
...
export default TeacherDailyAltSchoolCell;
