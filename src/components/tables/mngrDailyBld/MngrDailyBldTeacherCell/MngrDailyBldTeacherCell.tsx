...
type MngrDailyBldTeacherCellProps = {
    columnId: string;
    cell: DailyScheduleCell;
    type: ColumnType;
};

const MngrDailyBldTeacherCell: React.FC<MngrDailyBldTeacherCellProps> = ({ columnId, cell, type }) => {
...
export default MngrDailyBldTeacherCell;
