...
import MngrAnnualeBldAltByDayCell from "../MngrAnnualeBldAltByDayCell/MngrAnnualeBldAltByDayCell";
import styles from "./MngrAnnualeBldAltByDayTable.module.css";
import { AnnualInputCellType } from "@/models/types/annualSchedule";
import { SelectMethod } from "@/models/types/actions";
import { logErrorAction } from "@/app/actions/POST/logErrorAction";

type MngrAnnualeBldAltByDayTableProps = {
...
const MngrAnnualeBldAltByDayTable: React.FC<MngrAnnualeBldAltByDayTableProps> = ({
    schedule,
    selectedDay,
    subjects,
    teachers,
...
export default MngrAnnualeBldAltByDayTable;
