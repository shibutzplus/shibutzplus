...
import styles from "./TeacherDailyAltChangesTable.module.css";
...
type TeacherDailyAltChangesTableProps = {
    fromHour?: number;
    toHour?: number;
    selectedDate: string;
};

const TeacherDailyAltChangesTable: React.FC<TeacherDailyAltChangesTableProps> = ({
    fromHour = 1,
    toHour = 10,
    selectedDate,
}) => {
...
export default TeacherDailyAltChangesTable;
