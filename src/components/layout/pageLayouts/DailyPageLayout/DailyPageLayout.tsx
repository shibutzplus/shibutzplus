...
export default function DailyPageLayout({ children }: DailyPageLayoutProps) {
    const { daysSelectOptions, selectedDate, isLoading, isAutoAssigning, isPreviewMode, handleDayChange, autoAssignSchedule, hasMissingTeacherColumn } = useDailyTableContext();
    ...
    return (
        <>
            <PageLayout
                ...
                BottomActions={
                    <div className={styles.bar2DateSection}>
                        <div className={styles.bar2DateWrapper}>
            ...
            {isAutoAssigning && <div className={styles.blockingOverlay} />}
        </>
    );
}
