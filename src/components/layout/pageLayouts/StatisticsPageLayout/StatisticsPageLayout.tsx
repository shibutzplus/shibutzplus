...
const MONTH_OPTIONS = [{ value: "all", label: "כל השנה" }, ...SCHOOL_MONTHS.map((month) => ({ value: month, label: month }))];
...
export default function StatisticsPageLayout({ children, statType, setStatType, month, setMonth }: StatisticsPageLayoutProps) {
