    ...
    const faqItems = [
        {
            ...
            answer: (
                <>
                    ...
                    <strong>מורים ממלאי מקום</strong> – מורים ללא מערכת קבועה שאינם בצוות הקבוע, המוזמנים לפי הצורך.<br /><br />
                    מורה ממלא מקום רואה רק את המערכת האישית שלו ואינו חשוף לשינויים במערכת הבית ספרית.<br />
        ...
        },
        {
            ...
            answer: (
                <>
                    ...
                    <strong>מורים למילוי מקום</strong><br />
                    נכנסים למסך מורים ממלאי מקום ומפיקים לכל אחד מהם קישור אישי ייחודי ושולחים להם את הקישור האישי.
                    <br /><br />
