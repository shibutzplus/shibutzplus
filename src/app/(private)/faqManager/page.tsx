...
export default function FAQPage() {
    ...
    return (
        <div className="faq-container">
            ...
            <details>
                <summary>במסך שיבוץ יומי, אילו קטגוריות מופיעות בשדה ממלא המקום?</summary>
                <div className="answer">
            ...
            <details>
                <summary>כיצד ניתן לבדוק את המערכת ולראות אותה כפי שהמורים רואים אותה?</summary>
                <div className="answer">
                    במסך שיבוץ יומי יש ללחוץ על כפתור התצוגה המקדימה <Icons.validate size={22} />.<br />
                    במסך שייפתח תוצג המערכת היומית כפי שהמורים רואים אותה.<br />
                    כאן ניתן לוודא שכל השיבוצים בוצעו בצורה תקינה.
                </div>
            </details>
            ...
            <details>
                ...
                <div className="answer">
                    במסך שיבוץ יומי, בעמודות המורים, יש ללחוץ על סמל העין <Icons.eye size={22} />.<br />
