        ...
        },
        {
            ...
            answer: (
                <>
                    ...
                    <br />
                    <strong>אפשרויות נוספות:</strong> סימון מצבים מיוחדים כגון משוחררים הביתה, טיול,
                    הצגה או כל אפשרות אחרת.
                    <br />
                    <br />
                    <div style={{ marginRight: "20px" }}>
                        <ul>
                            ...
                            <li>
                                שימו לב: הקטגוריות מוצגות בהתאם לשעה שנבחרה ולמצב המורים בפועל באותה
                                שעה.
                            </li>
                        </ul>
                    </div>
