        ...
        <div className="faq-container">
            ...
            <details>
                ...
                <div className="answer">
                    ...
                    <strong>מלמדים בכיתה או בקבוצה:</strong> מורים המלמדים בכיתה או בקבוצה אחרת בשעה זו.<br />
                    <strong>לא התחילו/סיימו את היום:</strong> מורים שמלמדים היום אך אינם נמצאים כרגע בבית הספר (טרם הגיעו או כבר סיימו את יום העבודה).<br />
