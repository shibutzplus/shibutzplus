...
import MngrAnnualBldByClassTable from "@/components/tables/mngrAnnualBldByClass/MngrAnnualBldByClassTable/MngrAnnualBldByClassTable";
...
const AnnualSchedulePage: NextPage = () => {
    ...
    useEffect(() => {
        const checkSchedule = () => {
            ...
            return !hasIncompleteCells(schedule, "class");
        };
