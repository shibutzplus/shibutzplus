...
import MngrAnnualBldByTeacherTable from "@/components/tables/mngrAnnualBldByTeacher/MngrAnnualBldByTeacherTable/MngrAnnualBldByTeacherTable";
...
const AnnualSchedulePage: NextPage = () => {
    ...
    }, [teachers, annualScheduleTable, school?.id, schedule]);

    return (
        <div className={styles.container}>
            {selectedTeacherId ? (
                <MngrAnnualBldByTeacherTable
                    schedule={schedule}
