...
export async function GET(req: Request) {
  try {
    ...
    const allow = (url.searchParams.get("channels") || [DAILY_TEACHER_COL_DATA_CHANGED, DAILY_SCHOOL_DATA_CHANGED, LISTS_DATA_CHANGED, PUBLISH_DATA_CHANGED, MATERIAL_CHANGED].join(",")).split(",")
