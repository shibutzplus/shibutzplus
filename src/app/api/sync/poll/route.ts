...
export async function GET(req: Request) {
  try {
    ...
    const allow = (url.searchParams.get("channels") || [DAILY_TEACHER_COL_DATA_CHANGED, DAILY_SCHEDULE_DATA_CHANGED, ENTITIES_DATA_CHANGED, DAILY_PUBLISH_DATA_CHANGED, MATERIAL_CHANGED].join(",")).split(",")
