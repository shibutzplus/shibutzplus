...
// 1. Polyfill process.version — needed by readable-stream (used internally by next-auth).
//    The Edge Runtime provides a 'process' shim, but without 'version'.
if (typeof process !== "undefined" && !process.version) {
    (process as any).version = "v18.0.0";
}

// 2. Polyfill util.inspect.custom — needed by openid-client's [inspect.custom]() method.
