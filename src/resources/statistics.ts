import { StatisticsTypeValues } from "@/models/types/statistics";
...
export const STATISTICS_OPTIONS = [
    ...
    { value: StatisticsTypeValues.teachers, label: "היעדרויות לפי מורים" },
    { value: StatisticsTypeValues.days, label: "היעדרויות לפי ימי השבוע" },
];
