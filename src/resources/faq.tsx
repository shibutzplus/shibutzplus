...
export const FAQ_MANAGER_ITEMS: FaqItemResource[] = [
    ...
    },
    {
        question: (
            <>
                מה כפתור השיבוץ האוטומטי (<Icons.magic size={16} />) עושה?
            </>
        ),
        answer: () => (
            <>
                כפתור השיבוץ האוטומטי מופעל באמצעות אלגוריתם בינה מלאכותית אשר מבוסס על דפוסי שיבוץ בכל בתי הספר.
                <br />
                המערכת מזהה את דפוסי ההעדפה בבית הספר ומנסה להציע התאמה פדגוגית אופטימלית בין המורה המחליף לכיתה.
                <br />
                <br />
                <strong>השיבוץ האוטומטי:</strong>
                <div style={{ marginRight: "20px", marginTop: "6px" }}>
                    <ul>
                        <li>
                            <strong>משבץ רק מורים חסרים:</strong> המנגנון פועל אך ורק בעמודות של מורים חסרים (העמודות האדומות).
                        </li>
                        <li>
                            <strong>שומר על שיבוצים קיימים:</strong> השיבוץ האוטומטי לעולם אינו דורס שעות שכבר שובצו להן ממלא מקום, אלא משלים רק שעות ריקות.
                        </li>
                        <li>
                            <strong>מנסה ליצור איזון עומסים ושמירה על רצף:</strong> המערכת משקללת היכרות מוקדמת עם הכיתה, מונעת שחיקת מורים ושומרת על רצף לימודי של אותו מורה בכיתה.
                        </li>
                    </ul>
                </div>
                <br />
                חשוב לזכור כי יש להתייחס לשיבוץ האוטומטי כאל הצעה בלבד – אין תחליף להיכרות האישית, לידע הניהולי ולשיקול הדעת של המנהל.
            </>
        ),
    },
    {
    ...
    },
    {
        ...
        answer: () => (
            <>
                ...
                <br />
                במסך שייפתח ניתן לצפות בחומר הלימוד שהוזן ואפשר גם לשנות.
            </>
        ),
    },
    {
