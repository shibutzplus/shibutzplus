const messages = {
    ...
    auth: {
        accessDenied: "כדי להתנסות במערכת עליכם להיות רשומים. לחצו על צרו קשר או כיתבו לנו למייל shibutzplus@gmail.com",
    ...
    annualSchedule: {
        success: "מערכת שבועית נטענה בהצלחה",
        error: "בעיה בטעינת המערכת השבועית אנא נסו שוב",
        createSuccess: "שעה נוספה למערכת היומית בהצלחה",
        createError: "בעיה בהוספת שעה למערכת השבועית אנא נסו שוב",
        deleteSuccess: "שעה נמחקה מהמערכת היומית",
        deleteError: "בעיה במחיקת שעה במערכת השבועית אנא נסו שוב",
        updateSuccess: "השעה עודכנה במערכת השבועית בהצלחה",
        updateError: "בעיה בעדכון שעה במערכת השבועית אנא נסו שוב",
    },
    dailySchedule: {
