...
| **היכרות עם הכיתה (מורה מקצועי)** | **+30 נקודות** | מורה שמלמד את הכיתה הזו במערכת הרגילה ומכיר את התלמידים (לא חל על מחנך הכיתה). |
| **ממלא מקום מהמאגר בבית ליום מלא (4+ שעות)** | **+25 נקודות** | קריאה לממלא מקום ליום מלא היא מהלך טבעי ומקובל ומקבלת עדיפות למניעת פירוק מערכת המורים הפנימיים. |
...
| **מורים בקבוצות עבודה (פרטני/שהייה)** | **מינוס 5 נקודות** | עדיפות סבירה: קל להעביר מורה מפרטני למילוי מקום, עדיף בהרבה על הזעקת מורה מהבית. |
| **הגנה על שעות מחנך הכיתה (שחיקה)** | **מינוס 20 נקודות** | הגנה מבנית על חלונות של מחנך הכיתה (מורה עם רוב שעות הכיתה) מלהפוך לממלא מקום במקום שעות תכנון וקשר. |
...
| **שעת סוף יום (השעה האחרונה של המורה)** | **מינוס 10 נקודות** | עדיפות לשיבוץ בשעות חלון באמצע יום העבודה על פני הארכת היום בשעה האחרונה. |
| **הקדמת הגעה בשעה אחת (גמישות)** | **מינוס 25 נקודות** | מורה יכול להקדים בשעה אחת (שעה לפני תחילת יום עבודתו) בעדיפות מופחתת כשאין מורים אחרים זמינים. |
